...
export const ChatProvider: React.FC<ChatProviderProps> = ({ children }) => {
  const [messages, setMessages] = useState<Message[]>([
    {
      id: '1',
      text: "Hello! I'm your Mosquito Activity Index assistant. I can help you understand mosquito activity levels, prevention tips, and risk assessments. How can I help you today?",
      isBot: true,
      timestamp: new Date()
    }
  ]);
  ...
  const sendMessage = useCallback(async (text: string) => {
    ...
    try {
      ...
      const botResponse: Message = {
        ...
        text: weatherResponse.summary || 'I received your request but no summary was provided.',
        isBot: true,
        timestamp: new Date()
      };
